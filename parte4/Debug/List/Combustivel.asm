...
_0x0:
	.DB  0x43,0x6F,0x6D,0x62,0x75,0x73,0x74,0xED
	.DB  0x76,0x65,0x6C,0x20,0x3D,0x20,0x25,0x64
	.DB  0x0,0x41,0x74,0x65,0x6E,0xE7,0xE3,0x6F
	.DB  0x21,0x20,0x53,0x65,0x75,0x20,0x63,0x6F
	.DB  0x6D,0x62,0x75,0x73,0x74,0xED,0x76,0x65
	.DB  0x6C,0x20,0xE9,0x20,0x64,0x65,0x20,0x25
	.DB  0x64,0x0
__RESET:
	CLI
	CLR  R30
...
; 0000 000A if(PINB.3 == 1){
	SBIS 0x16,3
	RJMP _0x3
; 0000 000B PORTD.0 = ~PORTD.0;
	SBIS 0x12,0
	RJMP _0x4
	CBI  0x12,0
	RJMP _0x5
...
; 0000 000C }
; 0000 000D 
; 0000 000E if(PINB.4 ==1){
_0x3:
	SBIS 0x16,4
	RJMP _0x6
; 0000 000F PORTD.1 = ~PORTD.1;
	SBIS 0x12,1
	RJMP _0x7
	CBI  0x12,1
	RJMP _0x8
...
_0xB:
; 0000 001B 
; 0000 001C if (PINB.1 == 1){
_0x9:
	SBIS 0x16,1
	RJMP _0xC
; 0000 001D PORTD.6 = ~PORTD.6;}
	SBIS 0x12,6
	RJMP _0xD
	CBI  0x12,6
	RJMP _0xE
...
_0xE:
; 0000 001E 
; 0000 001F combustivel = combustivel - 6;
_0xC:
	RCALL SUBOPT_0x1
	LDI  R26,LOW(_combustivel)
	LDI  R27,HIGH(_combustivel)
...
; 0000 0023 { combustivel = combustivel - 20;
_timer1_ovf_isr:
; .FSTART _timer1_ovf_isr
	...
	LDI  R27,HIGH(_combustivel)
	RCALL __EEPROMWRW
; 0000 0024 if (PINB.6 == 1){
	SBIS 0x16,6
	RJMP _0xF
; 0000 0025 
; 0000 0026 PORTA.0 = ~PORTA.0 ;
	SBIS 0x1B,0
	RJMP _0x10
	CBI  0x1B,0
	RJMP _0x11
_0x10:
	SBI  0x1B,0
_0x11:
; 0000 0027 TCNT1H=0x1F00 >> 8;
	RCALL SUBOPT_0x2
; 0000 0028 TCNT1L=0x1F00 & 0xFF;
; 0000 0029 while(PORTA.0 == 1){
_0x12:
	SBIS 0x1B,0
	RJMP _0x14
; 0000 002A PORTA.0 = 1;
	SBI  0x1B,0
; 0000 002B if (PINB.6==0){
	SBIC 0x16,6
	RJMP _0x17
; 0000 002C PORTA.0 = 0;
	CBI  0x1B,0
...
; 0000 0034 
; 0000 0035 
; 0000 0036 if (PINB.7 == 1){
_0xF:
	SBIS 0x16,7
	RJMP _0x1A
; 0000 0037 
; 0000 0038 PORTA.1 = ~PORTA.1;
	SBIS 0x1B,1
	RJMP _0x1B
	CBI  0x1B,1
	RJMP _0x1C
_0x1B:
	SBI  0x1B,1
_0x1C:
; 0000 0039 TCNT1H=0x1F00 >> 8;
	RCALL SUBOPT_0x2
; 0000 003A TCNT1L=0x1F00 & 0xFF;
; 0000 003B 
; 0000 003C while(PORTA.1 == 1){
_0x1D:
	SBIS 0x1B,1
	RJMP _0x1F
; 0000 003D PORTA.1 = 1;
	SBI  0x1B,1
; 0000 003E if (PINB.7==0){
	SBIC 0x16,7
	RJMP _0x22
; 0000 003F PORTA.1 = 0;
	CBI  0x1B,1
...
; 0000 0056 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(3)
	OUT  0x1A,R30
; 0000 0057 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=0
...
; 0000 0064 PORTC=(0<<PORTC7) | (0<<PORTC6) | (1 <<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(32)
	OUT  0x15,R30
; 0000 0065 
; 0000 0066 // Port D initialization
; 0000 0067 // Function: Bit7=In Bit6=Out Bit5=Out Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=Out
; 0000 0068 DDRD=(0<<DDD7) | (1<<DDD6) | (0<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(83)
	OUT  0x11,R30
; 0000 0069 // State: Bit7=T Bit6=0 Bit5=0 Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=0
...
; 0000 0081 TCCR1A=0x00;
	OUT  0x2F,R30
; 0000 0082 TCCR1B=0x05;
	LDI  R30,LOW(5)
	OUT  0x2E,R30
; 0000 0083 TCNT1H=0x38;
	LDI  R30,LOW(56)
	OUT  0x2D,R30
; 0000 0084 TCNT1L=0x3F;
	LDI  R30,LOW(63)
	OUT  0x2C,R30
...
; 0000 00BE 
; 0000 00BF 
; 0000 00C0 // Globally enable interrupts
; 0000 00C1 #asm("sei")
	SEI
; 0000 00C2 
; 0000 00C3 while (1){
_0x25:
; 0000 00C4 
; 0000 00C5 //POR ALGUM MOTIVO N VI OS PRINTS NO MONITOR
; 0000 00C6 printf("Combustível = %d", combustivel);
	__POINTW1FN _0x0,0
	RCALL SUBOPT_0x3
; 0000 00C7 if(combustivel/1000<=10){
	LDI  R26,LOW(_combustivel)
	LDI  R27,HIGH(_combustivel)
	RCALL __EEPROMRDW
	MOVW R26,R30
	...
	SBIW R30,11
	BRGE _0x28
; 0000 00C8 printf("Atenção! Seu combustível é de %d",combustivel);}
	__POINTW1FN _0x0,17
	RCALL SUBOPT_0x3
; 0000 00C9 while(combustivel <=5){
_0x28:
_0x29:
	RCALL SUBOPT_0x1
	BRGE _0x2B
; 0000 00CA PORTA = 0x00;
	LDI  R30,LOW(0)
	OUT  0x1B,R30
...
; 0000 00D7 DDRD  = 0x00;
	OUT  0x11,R30
; 0000 00D8 //PRINTAR NA TELA REABASTECER E PEGAR LEITURA DO TECLADO E COLOCAR NA VARIAVEL COMBUSTIVEL
; 0000 00D9 }
	RJMP _0x29
_0x2B:
; 0000 00DA 
