...
_0x0:
	.DB  0x41,0x74,0x65,0x6E,0xE7,0xE3,0x6F,0x2E
	.DB  0x20,0x53,0x65,0x75,0x20,0x63,0x6F,0x6D
	.DB  0x62,0x75,0x73,0x74,0x69,0x76,0x65,0x6C
...
; 0000 0009 if(PINB.3 == 1){
	SBIS 0x16,3
	RJMP _0x3
; 0000 000A PORTD.0 = ~PORTD.0;
	SBIS 0x12,0
	RJMP _0x4
	CBI  0x12,0
	RJMP _0x5
...
; 0000 000B }
; 0000 000C 
; 0000 000D if(PINB.4 ==1){
_0x3:
	SBIS 0x16,4
	RJMP _0x6
; 0000 000E PORTD.1 = ~PORTD.1;
	SBIS 0x12,1
	RJMP _0x7
	CBI  0x12,1
	RJMP _0x8
...
; 0000 002D DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(3)
	OUT  0x11,R30
; 0000 002E // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 002F PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 0030 
...
; 0000 005F // INT0: On
; 0000 0060 // INT0 Mode: Rising Edge
; 0000 0061 // INT1: Off
; 0000 0062 // INT2: Off
; 0000 0063 GICR|=(0<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,0x40
	OUT  0x3B,R30
; 0000 0064 MCUCR=(0<<ISC11) | (0<<ISC10) | (1<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(2)
	OUT  0x35,R30
; 0000 0065 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0066 GIFR=(0<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(64)
	OUT  0x3A,R30
; 0000 0067 
...
; 0000 0077 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 0078 
...
; 0000 007F TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0080 
; 0000 0081 // Globally enable interrupts
; 0000 0082 #asm("sei")
	SEI
; 0000 0083 
; 0000 0084 while (1) {
_0x9:
; 0000 0085 if(combustivel/1000 <=10){
	LDI  R26,LOW(_combustivel)
	LDI  R27,HIGH(_combustivel)
	RCALL __EEPROMRDW
	MOVW R26,R30
	...
	SBIW R30,11
	BRGE _0xC
; 0000 0086 printf("Atenção. Seu combustivel é de %d",combustivel);
	__POINTW1FN _0x0,0
	ST   -Y,R31
	ST   -Y,R30
	LDI  R26,LOW(_combustivel)
