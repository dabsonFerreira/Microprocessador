...
_0x0:
	.DB  0x41,0x74,0x65,0x6E,0xE7,0xE3,0x6F,0x21
	.DB  0x20,0x53,0x65,0x75,0x20,0x63,0x6F,0x6D
	.DB  0x62,0x75,0x73,0x74,0xED,0x76,0x65,0x6C
	.DB  0x20,0xE9,0x20,0x64,0x65,0x20,0x25,0x64
	.DB  0x0
__RESET:
	CLI
	CLR  R30
...
; 0000 000D interrupt [3] void ext_int1_isr(void){
...
_0x5:
; 0000 0013 
; 0000 0014 if (PINB.1 == 1){
_0x3:
	SBIS 0x16,1
	RJMP _0x6
; 0000 0015 PORTD.6 = ~PORTD.6;}
	SBIS 0x12,6
	RJMP _0x7
	CBI  0x12,6
	RJMP _0x8
...
_0x8:
; 0000 0016 
; 0000 0017 combustivel = combustivel - 6;
_0x6:
...
; 0000 0034 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);// input 0
	OUT  0x17,R30
...
; 0000 0040 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=In Bit0=In
; 0000 0041 DDRD=(0<<DDD7) | (1<<DDD6) | (1<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(96)
	OUT  0x11,R30
; 0000 0042 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=T Bit0=T
; 0000 0043 PORTD=(0<<PORTD7) | (1<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0 <<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	LDI  R30,LOW(64)
	OUT  0x12,R30
; 0000 0044 
...
; 0000 0073 // INT0: Off
; 0000 0074 // INT1: On
; 0000 0075 // INT1 Mode: Low level
; 0000 0076 // INT2: On
; 0000 0077 // INT2 Mode: Falling Edge
; 0000 0078 GICR|=(1<<INT1) | (0<<INT0) | (1<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xA0)
	OUT  0x3B,R30
; 0000 0079 MCUCR=(0<<ISC11) | (0<<ISC10) | (1<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(2)
	OUT  0x35,R30
; 0000 007A MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 007B GIFR=(1<<INTF1) | (0<<INTF0) | (1<<INTF2);
	LDI  R30,LOW(160)
	OUT  0x3A,R30
; 0000 007C 
...
_0x9:
; 0000 009A 
; 0000 009B if(combustivel/1000<=10){
	LDI  R26,LOW(_combustivel)
	LDI  R27,HIGH(_combustivel)
	RCALL __EEPROMRDW
	MOVW R26,R30
	...
	SBIW R30,11
	BRGE _0xC
; 0000 009C printf("Atenção! Seu combustível é de %d",combustivel);
	__POINTW1FN _0x0,0
	ST   -Y,R31
	ST   -Y,R30
	LDI  R26,LOW(_combustivel)
