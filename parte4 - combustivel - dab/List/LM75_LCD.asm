...
; 0000 000C char aula[33];
; 0000 000D char matricula[33];
; 0000 000E 
...
; 0000 0078 // RS - PORTC Bit 0
; 0000 0079 // RD - PORTC Bit 1
; 0000 007A // EN - PORTC Bit 2
; 0000 007B // D4 - PORTC Bit 4
; 0000 007C // D5 - PORTC Bit 5
; 0000 007D // D6 - PORTC Bit 6
; 0000 007E // D7 - PORTC Bit 7
; 0000 007F // Characters/line: 8
...
; 0000 0085 
; 0000 0086 //        sprintf(aula,"     Dabson");
; 0000 0087 //        lcd_clear();
; 0000 0088 //        lcd_puts(aula);
; 0000 0089 //
; 0000 008A //        //lcd_gotoxy(4,1);
; 0000 008B //
; 0000 008C //
; 0000 008D //        lcd_gotoxy(3,1);
; 0000 008E //        sprintf(matricula,"201769030A");
; 0000 008F //        lcd_puts(matricula);
; 0000 0090 //
; 0000 0091 //
